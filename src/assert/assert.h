 ...
 * jumps to assert_panic() function, which normally sets the border to red
 * colour and hangs the machine.  A debugger can then be used to break
 * examine the hung machine and the cause of the failed assertion checked at
 * a fixed address.
 *
